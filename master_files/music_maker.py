...
import os
import numpy as np
from master_files.signal_converter_relay import DataThread
from master_files.board_communicator import Comms as boardComm
...
class NOMI:
    ...
    def loadWav(self):
        ...
        """
        pygame.mixer.init()
        musicFolder = f"..{os.path.sep}music{os.path.sep}"
...
if __name__ == '__main__':
    ...
    instrument = NOMI(boardId, serialPort, brainStateVal=1)
    instrument.start()
