...
# import signal_converter_relay
import board_communicator
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "NOMI version 1 [BETA]"))
    ...
    def startAction(self):
        ...
        instrument = music_maker.NOMI(-1, brainStateVal=brainState)
        instrument.start()
        instrument.loadWav()
    ...
    def startOpenBCIAction(self):
        ...
        brainState = self.currentBrainState
        instrument = music_maker.NOMI(0, inputSerial, brainStateVal=brainState)
        instrument.start()
        instrument.loadWav()
        runThread1 = Thread(target=instrument.brainAnalyzer)
        runThread1.start()
    ...
    def startMuseAction(self):
        ...
        brainState = self.currentBrainState
        instrument = music_maker.NOMI(22, inputSerial, brainStateVal=brainState)
        instrument.start()
        instrument.loadWav()
        runThread1 = Thread(target=instrument.brainAnalyzer)
        runThread1.start()
